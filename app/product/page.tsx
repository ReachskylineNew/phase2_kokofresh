...
export default function ProductPage() {
  const { add, getCartCount } = useCart()
  ...
  const formatDescription = (description: string) => {
    return (
      description
        ...
        .replace(/<ul>/g, '<ul class="space-y-1.5 ml-5 list-disc list-outside mb-2 sm:mb-3 text-[#3B2B13]">')
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#DD9627] via-[#FED649] to-[#B47B2B] text-[#3B2B13] font-sans">
      ...
      <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-2 sm:py-4 lg:py-6 mt-16 md:mt-24 pb-24 sm:pb-0">
  ...
  <CardContent className="p-3 space-y-2">
    ...
    <div className="flex flex-wrap items-start justify-between gap-3">
          ...
          >
            ...
            <Card className="border-2 border-[#3B2B13]/20 bg-white/90 shadow-lg hidden sm:block">
              <CardContent className="p-2 sm:p-4 space-y-1.5 sm:space-y-3">
                ...
                <div className="hidden sm:flex flex-col sm:flex-row gap-1 sm:gap-2 pt-1 sm:pt-1.5">
                  <Button
                    size="lg"
            ...
            {activeTab === "instructions" && (
              <div className="space-y-10 sm:space-y-12">
                ...
                <div className="flex items-center gap-4 mb-2 sm:mb-6">
                  ...
                  <div>
                    <h2 className="text-2xl sm:text-3xl font-serif font-bold text-[#DD9627]">How to Use</h2>
                        ...
                        <div
                          ...
                          dangerouslySetInnerHTML={{
                            __html: step
                              ...
                              .replace(
                                /Step\s*\d+:/gi,
                                (match) => `<span class="font-bold text-[#B47B2B] tracking-wide">${match}</span>`,
                              ),
                          }}
                        />
                      </div>
      ...
      {relatedProducts.length > 0 && (
        <div ref={relatedProductsRef} className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-8 sm:pb-12 lg:pb-16">
